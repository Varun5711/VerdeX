...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-200 overflow-hidden font-['Inter',sans-serif]">
      ...
      {/* ENHANCED HERO */}
      <section className="relative flex flex-col items-center justify-center px-6 md:px-12 pt-16 pb-20">
        <motion.div
        ...
        >
          ...
          <motion.p
            ...
            className="mt-0 text-xl md:text-2xl text-slate-300 font-light"
          >
      ...
      <section className="relative px-6 md:px-12 py-20 bg-gradient-to-r from-slate-900/50 to-slate-800/50">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
      ...
      <section className="relative px-6 md:px-12 py-10 bg-gradient-to-r from-slate-900/30 to-slate-800/30">
        <motion.h2
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
