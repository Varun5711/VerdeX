  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-slate-950">
      ...
      <div className="relative z-20 w-full max-w-2xl mx-auto px-8 py-0">
        ...
        {/* Subheadline */}
        <div
          className={`text-center mb-12 transform transition-all duration-700 delay-150 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
        >
          ...
          <SignUp
            appearance={{
              elements: {
                ...
                formFieldOptionalText: "text-slate-500 text-sm",
                formFieldInputGroup: "space-y-2",
                formFieldHintText: "text-slate-400 text-sm font-light",
                formFieldWarningText: "text-amber-400 text-sm",
                
                // Password strength indicator
                formFieldSuccessIcon: "text-emerald-400",
                formFieldErrorIcon: "text-red-400",
                formFieldWarningIcon: "text-amber-400",
                
                // Terms and conditions
                formFieldCheckbox: 
                  "bg-slate-800/60 border-slate-600/60 text-emerald-500 " +
                  "focus:ring-emerald-500/20 rounded",
                formFieldCheckboxLabel: "text-slate-300 text-sm font-light",
              },
              layout: {
